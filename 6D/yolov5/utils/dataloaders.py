...
from yolov5.utils.general import (DATASETS_DIR, LOGGER, NUM_THREADS, TQDM_BAR_FORMAT, check_dataset,
                           # check_requirements,
...
class LoadImages:
    ...
    def __init__(self, path, img_size=640, stride=32, auto=True, transforms=None, vid_stride=1):
        ...
        images = sorted(images, key=lambda x: int(x.split('/')[-1].split('.')[0]), reverse=True)
...
import numpy
class LoadSingleImages:
    #  image/video dataloader, i.e. `python detect.py --source image.jpg/vid.mp4`
    def __init__(self, path, img_size=640, stride=32, auto=True):
        self.is_array = True if isinstance(path, numpy.ndarray) else False
